...
`,[T("scrollbar",`
 ...
 `)]),_("render-label",`
 color: var(--n-text-color);
 `)]),Xe("disabled",[Y("&:hover",[_("state-border",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>G(`${e}-status`,[_("state-border",`border: var(--n-border-${e});`),Xe("disabled",[Y("&:hover",[_("state-border",`
