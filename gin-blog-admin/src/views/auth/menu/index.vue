<template>
  ...
  <CommonPage show-footer title="菜单管理">
    <template #action>
      <n-button type="primary" @click="handleClickAddMenu">
    ...
    >
      ...
      >
        ...
        <n-form-item label="是否隐藏" path="is_hidden">
          <n-switch v-model:value="modalForm.is_hidden" :checked-value="1" :unchecked-value="0" />
        </n-form-item>
...
const { getMenus, saveOrUpdateMenu, deleteMenu } = useAuthApi()
