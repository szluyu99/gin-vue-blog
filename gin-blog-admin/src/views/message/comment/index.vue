...
import { commentTypeOptions, commentTypeMap } from '@/constant/data'

import { useCommentApi } from '@/api'
const { getComments, deleteComments, updateCommentReview } = useCommentApi()
...
async function handleUpdateReview(ids, is_review) {
  await updateCommentReview({ ids, is_review })
