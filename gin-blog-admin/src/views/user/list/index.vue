...
import { loginTypeOptions, loginTypeMap } from '@/constant/data'

import { useUserApi, useAuthApi } from '@/api'
const { getUsers, updateUser, updateUserDisable } = useUserApi()
const { getRoleOption } = useAuthApi()
