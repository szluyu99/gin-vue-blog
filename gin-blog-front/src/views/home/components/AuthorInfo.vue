...
<template>
  <div class="card-view hidden animate-zoom-in text-center lg:block">
    <div class="flex justify-center">
      <img class="w-27 py-4 duration-600 hover:rotate-360" :src="convertImgUrl(blogConfig.website_avatar)" alt="author header">
    </div>
    <p class="text-xl">
    ...
    <div class="flex justify-center text-center">
      <button
        class="h-9 w-7/8 f-c-c transform rounded bg-blue-600 text-white transition-300 ease-in-out hover:scale-110 hover:bg-orange-600 hover:-translate-y-1"
        @click="addToFavorites"
      >
        <span class="i-material-symbols:bookmark mr-5 text-xl" /> 加入书签
      </button>
    </div>
    <!-- 社交信息 -->
    <div class="my-4 px-10 text-2xl space-x-5">
