...
const (
	...
	ERROR_DB_OPERATION    = 9004
	ERROR_REDIS_OPERATION = 9005
	...
	ERROR_ROLE_EMPTY            = 60012

	// code=7000 ... 页面模块的错误
	ERROR_PAGE_NAME_EXIST  = 7001
	ERROR_PAGE_LABEL_EXIST = 7002
)
...
var codeMsg = map[int]string{
	...
	ERROR_DB_OPERATION:    "数据库操作异常",
	ERROR_REDIS_OPERATION: "Redis 操作异常",
	...
	ERROR_ROLE_EMPTY:            "每个用户至少拥有一个角色",

	ERROR_PAGE_NAME_EXIST:  "该页面名称已经存在",
	ERROR_PAGE_LABEL_EXIST: "该页面标签已经存在",
}
