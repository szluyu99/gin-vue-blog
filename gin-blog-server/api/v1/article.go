...
func (*Article) SaveOrUpdate(c *gin.Context) {
	...
	r.Code(c, articleService.SaveOrUpdate(
...
func (*Article) SoftDelete(c *gin.Context) {
	...
	r.Code(c, articleService.SoftDelete(req.Ids, req.IsDelete))
}

// 物理删除
func (*Article) Delete(c *gin.Context) {
	r.Code(c, articleService.Delete(utils.BindJson[[]int](c)))
}

// 获取文章列表
func (*Article) GetList(c *gin.Context) {
	r.Success(c, articleService.GetList(utils.BindQuery[req.GetArts](c)))
}

// 获取文章详细信息
func (*Article) GetInfo(c *gin.Context) {
	r.Success(c, articleService.GetInfo(utils.GetIntParam(c, "id")))
}

// 修改置顶信息
func (*Article) UpdateTop(c *gin.Context) {
	r.Code(c, articleService.UpdateTop(utils.BindValidJson[req.UpdateArtTop](c)))
}

// 导出文章: 获取导出后的资源链接列表
func (*Article) Export(c *gin.Context) {
	r.Success(c, articleService.Export(utils.BindJson[[]int](c)))
}
